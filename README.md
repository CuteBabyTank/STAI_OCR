...
| _Clarence Ang_     | SQL Agent · ReAct Agent · LLMOps Monitoring          |
| _Fraser Sim_       | Prompt Engineering · Structured Outputs · Guardrails |
| _Aaron Go_         | RAG · Memory · Tool Use · Disambiguation             |
